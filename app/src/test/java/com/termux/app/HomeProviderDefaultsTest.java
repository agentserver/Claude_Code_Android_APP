...
public class HomeProviderDefaultsTest {
    ...
    public void providerAwarePagesUseCodexAsFieldDefault() throws Exception {
        String agentServer = readSource("src/main/java/com/termux/app/AgentServerFragment.java");
        String apiKey = readSource("src/main/java/com/termux/app/ApiKeyFragment.java");
