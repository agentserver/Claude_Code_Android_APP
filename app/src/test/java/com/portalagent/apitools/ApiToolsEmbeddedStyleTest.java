...
public class ApiToolsEmbeddedStyleTest {
    ...
    public void apiToolsUsesSharedControllerForActivityAndFragment() throws Exception {
        String activity = readSource("src/main/java/com/portalagent/activities/ApiToolsActivity.java");
        String fragment = readSource("src/main/java/com/portalagent/apitools/ApiToolsFragment.java");
        String controller = readSource("src/main/java/com/portalagent/apitools/ApiToolsController.java");
