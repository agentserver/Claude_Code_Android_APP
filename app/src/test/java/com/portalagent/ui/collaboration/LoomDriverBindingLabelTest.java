...
public class LoomDriverBindingLabelTest {
    ...
    public void loomPageRoleSelectorOnlyKeepsObserverAndSlave() throws Exception {
        String source = readSource("src/main/java/com/portalagent/ui/collaboration/LoomFragment.java")
            .replace("\r\n", "\n");
    ...
    public void collaborationBindButtonDoesNotSkipCredentialProbeForCachedValidStatus() throws Exception {
        String source = readSource("src/main/java/com/portalagent/ui/collaboration/CollaborationFragment.java")
            .replace("\r\n", "\n");
