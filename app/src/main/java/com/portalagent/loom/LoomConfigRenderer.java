...
public final class LoomConfigRenderer {
    ...
    public static String renderManagedSlaveConfig(
        ...
        String folder = safeSlave.folder.isEmpty() ? safeSettings.agentProvider == com.portalagent.provider.AssistantProvider.CODEX
    ...
    private static String renderAgentBackend(LoomSettings s, String workdir) {
        if (s.agentProvider == com.portalagent.provider.AssistantProvider.CODEX) {
            return ""
                + "agent:\n"
                + "  kind: codex\n"
                + "codex:\n"
