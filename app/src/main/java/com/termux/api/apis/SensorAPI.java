...
public class SensorAPI {
    ...
    public static String getSensorListJson(Context context) {
        SensorManager sensorManager = (SensorManager) context.getSystemService(Context.SENSOR_SERVICE);
        if (sensorManager == null) {
            return "{\"sensors\":[]}";
        }

        SensorCommandResult result = SensorReaderService.listHandler.handle(sensorManager, context, new Intent());
        return result != null ? result.message : "{\"sensors\":[]}";
    }
